...
namespace core
{
class OP_API wavelet_encode_plan : public opPlan
{
public:
	wavelet_encode_plan();
...
class OP_API wavelet_encode_array_pset : public opArrayParamSet
{
public:
...
class OP_API wavelet_encode_plan_pset : public opPlanParamSet
{
public:
