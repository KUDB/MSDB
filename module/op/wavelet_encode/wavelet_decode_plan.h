...
namespace core
{
class OP_API wavelet_decode_plan : public opPlan
{
public:
	wavelet_decode_plan();
...
class OP_API wavelet_decode_array_pset : public opArrayParamSet
{
public:
...
class OP_API wavelet_decode_plan_pset : public opPlanParamSet
{
public:
