...
namespace core
{
class OP_API naive_filter_plan : public opPlan
{
public:
	naive_filter_plan();
...
class OP_API naive_filter_array_pset : public opArrayParamSet
{
public: 
	naive_filter_array_pset(parameters& pSet);
};

class OP_API naive_filter_plan_pset : public opPlanParamSet
{
public:
