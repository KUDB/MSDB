...
namespace core
{
class OP_API encode_raw_plan : public opPlan
{
public:
	encode_raw_plan();
	~encode_raw_plan();
...
class OP_API encode_raw_array_pset : public opArrayParamSet
{
public:
	encode_raw_array_pset(parameters& pSet);
};

class OP_API encode_raw_plan_pset : public opPlanParamSet
{
public:
