...
namespace core
{
class OP_DLL_API compass_encode_plan : public opPlan
{
public:
	compass_encode_plan();
...
class OP_DLL_API compass_encode_array_pset : public opArrayParamSet
{
public:
	compass_encode_array_pset(parameters& pSet);
};

class OP_DLL_API compass_encode_plan_pset : public opPlanParamSet
{
public:
