...
std::vector<std::vector<iFixedHuffmanCoder*>> seHuffmanChunk<Ty_>::fixedHuffmanCoders =
{
	...
	},
	{
		...
		fixedHuffmanCoderLonger<1, uint8_t>::instance(),
		fixedHuffmanCoderLonger<1, uint8_t>::instance(),
		fixedHuffmanCoderLonger<2, uint8_t>::instance(),
		fixedHuffmanCoderLonger<3, uint8_t>::instance(),
		fixedHuffmanCoderLonger<4, uint16_t>::instance(),
		fixedHuffmanCoderLonger<5, uint16_t>::instance(),
		fixedHuffmanCoderLonger<6, uint16_t>::instance(),
		fixedHuffmanCoderLonger<7, uint32_t>::instance(),
		fixedHuffmanCoderLonger<8, uint32_t>::instance(),
		fixedHuffmanCoder<9, uint8_t>::instance(),
		fixedHuffmanCoder<10, uint8_t>::instance(),
		fixedHuffmanCoder<11, uint8_t>::instance(),
		fixedHuffmanCoder<12, uint8_t>::instance(),
