...
namespace core
{
class OP_DLL_API se_huffman_encode_plan : public opPlan
{
public:
...
//////////////////////////////
// ParamSets
class OP_DLL_API se_huffman_encode_array_pset : public opArrayParamSet
{
public:
	se_huffman_encode_array_pset(parameters& pSet);
};

class OP_DLL_API se_huffman_encode_plan_pset : public opPlanParamSet
{
public:
