...
//////////////////////////////
// index_filter_plan
class OP_API index_filter_plan : public opPlan
{
public:
	index_filter_plan();
...
class OP_API index_filter_pset
{
protected:
...
//////////////////////////////
// index_filter_array_pset
class OP_API index_filter_array_pset : public opArrayParamSet, public index_filter_pset
{
public:
...
class OP_API index_filter_plan_pset : public opPlanParamSet, public index_filter_pset
{
public:
