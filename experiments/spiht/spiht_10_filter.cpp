...
{
TEST(spiht_10_filter, star1024x1024)
{
...
TEST(spiht_10_filter, saturn1024x1024)
{
...
TEST(spiht_10_filter, solar1024x1024)
{
...
TEST(spiht_10_filter, mars4096x2048)
{
...
TEST(spiht_10_filter, mercury20480x10240)
{
...
TEST(spiht_10_filter, lunar102400x40960)
{
...
// 3D Data
////////////////////////////////////////
TEST(spiht_10_filter, data_solar_sdo_1024x1024x512)
{
...
TEST(spiht_10_filter, data_nexrad_201711_64x24x1024x2048)
{
