...
{
TEST(lzw_10_filter, star1024x1024)
{
...
TEST(lzw_10_filter, saturn1024x1024)
{
...
TEST(lzw_10_filter, solar1024x1024)
{
...
TEST(lzw_10_filter, mars4096x2048)
{
...
TEST(lzw_10_filter, mercury20480x10240)
{
...
TEST(lzw_10_filter, lunar102400x40960)
{
...
// 3D Data
////////////////////////////////////////
//TEST(lzw_10_filter, data_star64x64x64)
//{
...
//								 msdb::core::compressionType::LZW);
//}
TEST(lzw_10_filter, data_solar_sdo_1024x1024x512)
{
...
TEST(lzw_10_filter, data_nexrad_16x1024x2048)
{
