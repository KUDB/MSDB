...
// 3D Data
////////////////////////////////////////
//TEST(lzwHuffman_10_filter, data_star64x64x64)
//{
...
TEST(lzwHuffman_10_filter, data_solar_sdo_1024x1024x512)
{
	...
	experimentFilterQry<uint16_t>(msdb::dummy::data_solar_sdo_1024x1024x512::arrName,
								  msdb::core::compressionType::LZW_HUFFMAN);
}
TEST(lzwHuffman_10_filter, data_nexrad_201711_64x24x1024x2048)
{
	...
	experimentFilterQry<uint16_t>(msdb::dummy::data_nexrad_201711_64x24x1024x2048::arrName,
								  msdb::core::compressionType::LZW_HUFFMAN);
}
}		// experiments
}		// msdb