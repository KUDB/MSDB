...
{
TEST(compass_04_save, star1024x1024)
{
	dummy::data_star1024x1024::executeBuildArray(
		core::materializedType::FLATTEN, core::compressionType::COMPASS);

	dummy::executeInsertSaveArray(dummy::data_star1024x1024::arrName,
								  dummy::data_star1024x1024::filePath,
								  core::compressionType::COMPASS);
}
TEST(compass_04_save, saturn1024x1024)
{
...
TEST(compass_04_save, solar1024x1024)
{
...
TEST(compass_04_save, mars4096x2048)
{
...
TEST(compass_04_save, mercury20480x10240)
{
...
TEST(compass_04_save, lunar102400x40960)
{
...
// 3D Data
////////////////////////////////////////
TEST(compass_04_save, data_nexrad_16x1024x2048)
{
...
TEST(compass_04_save, data_solar_sdo_1024x1024x512)
{
...
TEST(compass_04_save, data_nexrad_201711_64x24x1024x2048)
{
