...
TEST(sz_04_save, star1024x1024)
{
	...
	dummy::executeInsertSaveArray(dummy::data_star1024x1024::arrName,
								  ...
								  core::compressionType::SZ);
}
TEST(sz_04_save, saturn1024x1024)
{
...
TEST(sz_04_save, solar1024x1024)
{
...
TEST(sz_04_save, mercury20480x10240)
{
...
TEST(sz_04_save, lunar102400x40960)
{
...
// 3D Data
////////////////////////////////////////
TEST(sz_04_save, data_solar_sdo_1024x1024x512)
{
...
TEST(sz_04_save, data_nexrad_201711_64x24x1024x2048)
{
