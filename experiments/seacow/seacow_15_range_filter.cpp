...
{
TEST(seacow_15_range_filter, data_star1024x1024)
{
...
TEST(seacow_15_range_filter, data_saturn1024x1024)
{
...
TEST(seacow_15_range_filter, data_solar1024x1024)
{
...
TEST(seacow_15_range_filter, data_mars4096x2048)
{
...
TEST(seacow_15_range_filter, data_mercury20480x10240)
{
...
TEST(seacow_15_range_filter, data_lunar102400x40960)
{
...
// 3D Data
////////////////////////////////////////
TEST(seacow_15_range_filter, data_solar_sdo_1024x1024x512)
{
...
TEST(seacow_15_range_filter, data_nexrad_201711_64x24x1024x2048)
{
