...
// 3D Data
////////////////////////////////////////
TEST(seacow_01_build, data_star64x64x64)
{
	dummy::data_star64x64x64::executeBuildArray(
		core::materializedType::FLATTEN, core::encodingType::SEACOW);
}
TEST(seacow_01_build, data_nexrad_16x1024x2048)
{
