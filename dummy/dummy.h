...
static const std::string filePath = DUMMY_PATH(Binary_Star_STSCI_H_p1942a_f_1024x1024.txt);
...
static const std::string filePath = DUMMY_PATH(Binary_Solar_latest10240171_1024x1024.txt);
...
static const std::string filePath = DUMMY_PATH(Binary_Saturn_STSCI_H_p1936a_f_1024x1024.txt);
...
static const std::string filePath = DUMMY_PATH(Binary_Mars_Viking_MDIM21_ClrMosaic_1km_4096x2048.txt);
...
static const std::string filePath = DUMMY_PATH(Binary_Mercury_Messenger_DEM_Global_665m_v2_max_23040x11520.txt);
...
static const std::string filePath = DUMMY_PATH(Binary_Lunar_LRO_WAC_GLD100_DTM_79S79N_100m_v1_109165x47912.txt);
