...
//
adaptHuffmanChunkType::adaptHuffmanChunkType(const dataType& type)
	: chunkType(buildFactory(adaptHuffmanChunkFactoryBuilder(), type))
{
}

//REGISTER_CHUNK_FACTORY("adaptHuffmanChunk", adaptHuffmanChunkFactoryBuilder())
