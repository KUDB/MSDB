...
namespace core
{
msdb::core::fast_wavelet_encode_action::fast_wavelet_encode_action()
{
	this->waveletName_ = "HaarSimple";
}

fast_wavelet_encode_action::~fast_wavelet_encode_action()
{
}

pArray fast_wavelet_encode_action::execute(std::vector<pArray>& inputArrays, pQuery qry)
{
...
const char* msdb::core::fast_wavelet_encode_action::name()
{
